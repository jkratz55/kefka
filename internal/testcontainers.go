...
// THIS CODE IS A FORK FROM THE OFFICIAL TESTCONTAINERS-GO REPOSITORY. I COPIED
// AND PASTED THIS CODE HERE BECAUSE THERE IS AN OPEN DEFECT WHERE THE CONTAINER
// WILL NEVER START UP PROPERLY WITH THE CURRENT VERSION OF THE LIBRARY AND THE
// LATEST VERSION OF DOCKER DESKTOP. THE FIX IS TO OVERRIDE LIFE CYCLE HOOKS,
// SPECIFICALLY THE POST STARTS HOOKS. THE FIX IS TO ADD A SLEEP TIMER TO WAIT
// FOR THE CONTAINER TO START UP PROPERLY. I HOPE TO ONE DAY REMOVE THIS CODE BUT
// UNTIL THAT ISSUE IS ADDRESSED I'M FORCED TO KEEP THIS HERE BECAUSE I WANT TO MAKE
// USE OF TESTCONTAINERS FOR TESTING WITH A REAL KAFKA INSTANCE.
